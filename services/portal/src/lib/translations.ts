...
const translations = {
  ...
  leads: {
    ...
    quoteStatus_draft: { fr: 'Brouillon', en: 'Draft' },
    quoteStatus_sent: { fr: 'Envoyée', en: 'Sent' },
    quoteStatus_accepted: { fr: 'Acceptée', en: 'Accepted' },
    quoteStatus_rejected: { fr: 'Refusée', en: 'Rejected' },
    quoteStatus_expired: { fr: 'Expirée', en: 'Expired' },
    delete: { fr: 'Supprimer', en: 'Delete' },
    // Table headers
  ...
  businesses: {
    ...
    subtitle: { fr: 'Entreprises locales et historique de visites', en: 'Local businesses and visit history' },
