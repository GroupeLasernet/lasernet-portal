      ...
      <div className="min-h-screen bg-gradient-to-br from-brand-50 to-white flex items-center justify-center p-4">
        <div className="max-w-md w-full">
          <div className="card">
            ...
            <h1 className="text-lg font-semibold text-center text-gray-900 mb-2">Invalid Reset Link</h1>
      ...
      <div className="min-h-screen bg-gradient-to-br from-brand-50 to-white flex items-center justify-center p-4">
        <div className="max-w-md w-full">
          <div className="card">
            ...
            <h1 className="text-lg font-semibold text-center text-gray-900 mb-2">Password Reset!</h1>
            <p className="text-center text-gray-600 text-sm mb-6">
