...
// GET /api/stations/[id]/robot-programs/[programId] — Get single program with full waypoint data
export async function GET(request: NextRequest, { params }: { params: RouteParams }) {
  try {
    const { id, programId } = params;

    const program = await prisma.stationRobotProgram.findUnique({
      where: { id: programId },
    });

    if (!program || program.stationId !== id) {
...
// POST /api/stations/[id]/robot-programs/[programId] — Update program
export async function POST(request: NextRequest, { params }: { params: RouteParams }) {
  try {
    ...
    const updated = await prisma.stationRobotProgram.update({
      where: { id: programId },
      data: {
...
// DELETE /api/stations/[id]/robot-programs/[programId] — Delete program
export async function DELETE(request: NextRequest, { params }: { params: RouteParams }) {
  try {
    ...
    await prisma.stationRobotProgram.delete({
      where: { id: programId },
    });
