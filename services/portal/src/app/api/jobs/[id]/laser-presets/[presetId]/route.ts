...
// GET /api/jobs/[id]/laser-presets/[presetId] — Get single preset
export async function GET(request: NextRequest, { params }: { params: RouteParams }) {
  try {
    const { id, presetId } = params;

    const preset = await prisma.jobLaserPreset.findUnique({
      where: { id: presetId },
    });

    if (!preset || preset.jobId !== id) {
...
// POST /api/jobs/[id]/laser-presets/[presetId] — Update preset
export async function POST(request: NextRequest, { params }: { params: RouteParams }) {
  try {
    ...
    const updated = await prisma.jobLaserPreset.update({
      where: { id: presetId },
      data: {
...
// DELETE /api/jobs/[id]/laser-presets/[presetId] — Delete preset
export async function DELETE(request: NextRequest, { params }: { params: RouteParams }) {
  try {
    ...
    await prisma.jobLaserPreset.delete({
      where: { id: presetId },
    });
