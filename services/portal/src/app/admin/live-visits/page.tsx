      ...
      <div className={`bg-gray-950 border border-white/10 overflow-hidden transition-all duration-300 ${
        ...
        <div className="px-6 py-5 border-b border-white/10 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-lg font-bold text-white">{t('liveVisits', 'liveTitle')}</h2>
          </div>
                            ...
                            >
                              ...
                              <div className="min-w-0 flex-1">
                                <div className="flex items-center gap-1.5 w-full">
                                  <button
                                    onClick={(e) => { e.stopPropagation(); handleSetMainContact(vg.id, visitor.leadId); }}
                                  ...
                                  >
                                    {visitor.isMainContact ? (
                                      ...
                                      <svg className="w-4 h-4 text-white/20 hover:text-yellow-400/60" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                                      </svg>
                                    )}
                                  </button>
                                  <span className="text-sm font-medium text-white truncate">{visitor.name}</span>
                                </div>
